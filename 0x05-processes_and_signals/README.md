...
Using your [previous exercise](./1-list_your_processes) command, write a Bash script that displays lines containing the bash word, thus allowing you to easily get the `PID` of your Bash process.
...
Write a Bash script that stops [4-to_infinity_and_beyond](./4-to_infinity_and_beyond) process.
...
Write a Bash script that kills the process [7-highlander](./7-highlander).
...
![4](https://user-images.githubusercontent.com/85158665/235211002-7c12f0d3-4392-483a-9f3a-5796f7c0b9da.jpg)
...
Write a [manage_my_process](./manage_my_process) Bash script that:

* Indefinitely writes `I am alive!` to the file `/tmp/my_process`
* In between every `I am alive!` message, the program should pause for `2` seconds

Write Bash (init) script [101-manage_my_process](./101-manage_my_process) that manages [manage_my_process](./manage_my_process). (*both files need to be pushed to git*)
